...
namespace WC_Popup_Notification\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'WC_Popup_Notification\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( WPN_PLUGIN_PATH ), $directory, $file_name );
...
spl_autoload_register( '\WC_Popup_Notification\Inc\Helpers\autoloader' );
